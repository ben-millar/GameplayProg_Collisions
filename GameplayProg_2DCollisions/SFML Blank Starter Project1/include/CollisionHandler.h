...
public:
	...
	static bool resolve(AABB_Obj const&, Ray_Obj const&);
	static bool resolve(Capsule_Obj const&, Circle_Obj const&);
	static bool resolve(Capsule_Obj const&, Polygon_Obj const&);
	static bool resolve(Capsule_Obj const&, Ray_Obj const&);
	static bool resolve(Circle_Obj const&, Polygon_Obj const&);
	static bool resolve(Circle_Obj const&, Ray_Obj const&);
	static bool resolve(Polygon_Obj const&, Ray_Obj const&);
};
